...
| # | Criterion | Result |
|---|---|---|
| 1 | Cross-engine hash equality test passes for every fixture string | **PASS** |
| 2 | Postgres `timestamptz(6)` vs ClickHouse `DateTime` → differences within the same second are not reported; a TS-2 note appears once | **PASS** |
| 3 | Postgres `numeric(12,2)` vs ClickHouse `Decimal(12,4)` → compared at scale 2, DEC-1 note | **PASS** |
| 4 | ClickHouse `Nullable(String)` NULL vs Postgres NULL → equal | **PASS** |
| 5 | 100M-row benchmark — correctness | **PASS** — exactly the 1,000 introduced differences (400 missing, 300 extra, 300 changed), nothing else |
| 5 | 100M-row benchmark — memory under 500 MB | **PASS** — 127.5 MB peak client RSS |
| 5 | 100M-row benchmark — under 5 minutes | **FAIL** — 8.95 min (536.8s), 1.8× over budget. Root-caused to a genuine CPU-core ceiling on this shared 8-vCPU dev VM (Postgres already spawns 2 internal parallel workers per query, so 4 client threads become ~12 competing backend processes), not a fixable software inefficiency. Investigated and accepted — full writeup in [`benchmarks.md`](benchmarks.md). |
...
this session); `DateTime`/`DateTime64` precision (TS-2); `Nullable()`
handling; `LowCardinality`, `Enum8`/`Enum16`, `Array`, `Map` (as text,
UNK-1) types.
...
**209 passed, 0 skipped** — every test in `tests/integration/test_clickhouse_real.py`
now runs for real (none skip for an unreachable server anymore).
...
tests/integration/test_clickhouse_real.py::TestNullableAcrossEngines::test_clickhouse_nullable_string_null_equals_postgres_null PASSED [  3%]
tests/integration/test_clickhouse_real.py::TestClickHouseKeySegmentation::test_uint64_key_segments_and_matches PASSED [  4%]
tests/integration/test_clickhouse_real.py::TestClickHouseKeySegmentation::test_string_key_segments_and_matches PASSED [  4%]
tests/integration/test_clickhouse_real.py::TestClickHouseKeySegmentation::test_uuid_key_segments_and_matches PASSED [  5%]
tests/integration/test_clickhouse_real.py::TestClickHouseSpecificTypes::test_enum_array_map_lowcardinality_nullable_self_diff_matches PASSED [  5%]
tests/integration/test_clickhouse_real.py::TestClickHouseSpecificTypes::test_enum_array_map_reports_a_real_change PASSED [  6%]
tests/integration/test_clickhouse_real.py::TestCliSupportsClickHouse::test_cli_diff_postgres_to_clickhouse_returns_exit_0_on_match PASSED [  6%]
tests/integration/test_joindiff_real.py::TestJoindiffAgainstRealPostgres::test_identical_tables_match PASSED [  7%]
tests/integration/test_joindiff_real.py::TestJoindiffAgainstRealPostgres::test_missing_extra_and_changed_rows_in_a_single_query PASSED [  7%]
tests/integration/test_joindiff_real.py::TestJoindiffAgainstRealPostgres::test_dec_1_pair_scale_applies_inside_the_join PASSED [  8%]
tests/integration/test_joindiff_real.py::TestJoindiffAgainstRealPostgres::test_max_diff_rows_bounds_the_detail_fetch_with_exact_counts PASSED [  8%]
...
tests/integration/test_m0_acceptance.py::TestCliExitCodesAgainstRealPostgres::test_cli_diff_returns_exit_0_when_tables_match PASSED [  9%]
...
tests/integration/test_m0_acceptance.py::TestIdenticalOneMillionRows::test_two_identical_1m_row_tables_match_exit_0_under_10s PASSED [ 10%]
...
tests/integration/test_m0_acceptance.py::TestEmptyTableEdgeCases::test_source_empty_target_has_rows_reports_all_as_extra PASSED [ 11%]
tests/integration/test_m0_acceptance.py::TestEmptyTableEdgeCases::test_target_empty_source_has_rows_reports_all_as_missing PASSED [ 11%]
tests/integration/test_m0_acceptance.py::TestEmptyTableEdgeCases::test_both_sides_empty_is_a_match PASSED [ 12%]
tests/integration/test_m0_acceptance.py::TestColumnsAndExclude::test_exclude_hides_a_differing_column_from_the_diff PASSED [ 12%]
tests/integration/test_m0_acceptance.py::TestColumnsAndExclude::test_columns_restricts_comparison_to_the_named_set PASSED [ 13%]
tests/integration/test_m0_acceptance.py::TestWhereFilteringReal::test_where_excludes_rows_on_both_sides_real_postgres PASSED [ 13%]
tests/integration/test_m0_acceptance.py::TestWhereFilteringReal::test_where_source_and_where_target_differ_per_side_real_postgres PASSED [ 14%]
tests/integration/test_m0_acceptance.py::TestWhereFilteringReal::test_duplicate_key_scoped_by_where_real_postgres PASSED [ 14%]
tests/integration/test_m0_acceptance.py::TestWhereFilteringReal::test_cli_where_flag_end_to_end PASSED [ 15%]
tests/integration/test_m0_acceptance.py::TestMixedCaseTextKeysReal::test_mixed_case_text_keys_diff_correctly_under_locale_aware_collation PASSED [ 15%]
tests/integration/test_m0_acceptance.py::TestCompositeKeyReal::test_composite_key_tenant_id_order_id PASSED [ 16%]
tests/integration/test_m0_acceptance.py::TestTextColumnsWithLeadingZerosAreNotCorrupted::test_leading_zero_text_value_is_reported_intact_not_as_a_corrupted_int PASSED [ 16%]
tests/integration/test_m0_acceptance.py::TestUuidKeySegmentBalance::test_uuid_key_no_segment_holds_more_than_2x_average PASSED [ 17%]
tests/integration/test_m0_acceptance.py::TestSegmentQueriesUsePkIndex::test_uuid_key_segment_query_uses_pk_index PASSED [ 17%]
...
tests/integration/test_m0_acceptance.py::TestNoPrimaryKeyExitsTwo::test_table_without_pk_and_no_key_flag_exits_2_with_clear_message PASSED [ 18%]
...
tests/integration/test_m0_acceptance.py::TestNonUniqueKeyExitsTwo::test_non_unique_key_exits_2_and_shows_duplicate_example PASSED [ 19%]
...
tests/integration/test_m0_acceptance.py::TestNetworkDropMidRun::test_postgres_actually_killed_mid_run_is_a_clean_error_no_traceback PASSED [ 20%]
...
tests/integration/test_m0_acceptance.py::TestThreadedHashdiffMatchesSequential::test_parallel_result_matches_sequential_result_exactly PASSED [ 21%]
...
tests/integration/test_m1_cli.py::TestAlgorithmAutoSelection::test_auto_picks_joindiff_when_both_sides_are_the_same_database PASSED [ 22%]
tests/integration/test_m1_cli.py::TestAlgorithmAutoSelection::test_auto_picks_hashdiff_when_databases_differ PASSED [ 22%]
tests/integration/test_m1_cli.py::TestAlgorithmAutoSelection::test_algorithm_hashdiff_forces_hashdiff_even_on_the_same_database PASSED [ 23%]
tests/integration/test_m1_cli.py::TestNormalisationFlagsEndToEnd::test_trim_flag_makes_trailing_whitespace_match PASSED [ 23%]
tests/integration/test_m1_cli.py::TestNormalisationFlagsEndToEnd::test_column_map_flag_matches_differently_named_columns PASSED [ 24%]
tests/integration/test_m1_cli.py::TestNullRenderedAsNullNotBackslashN::test_terminal_output_shows_null_not_backslash_n PASSED [ 24%]
tests/integration/test_m1_cli.py::TestNullRenderedAsNullNotBackslashN::test_json_output_shows_null_not_backslash_n PASSED [ 25%]
tests/integration/test_m1_cli.py::TestJsonOutputM1Fields::test_json_output_carries_excluded_columns_timings_and_sql PASSED [ 25%]
tests/integration/test_m1_fixtures.py::TestTimestampFixtures::test_tz_aware_converts_to_utc_iso8601 PASSED [ 26%]
tests/integration/test_m1_fixtures.py::TestTimestampFixtures::test_naive_timestamp_rendered_as_is_with_z_suffix_and_warns_once PASSED [ 26%]
tests/integration/test_m1_fixtures.py::TestTimestampFixtures::test_min_and_max_timestamps PASSED [ 27%]
tests/integration/test_m1_fixtures.py::TestTs2PrecisionMismatch::test_truncating_to_lower_precision_makes_same_second_a_match PASSED [ 27%]
...
tests/integration/test_m1_fixtures.py::TestTs2PrecisionMismatch::test_rounds_half_up_at_lower_precision_not_truncates PASSED [ 28%]
...
tests/integration/test_m1_fixtures.py::TestTs2TimePrecisionMismatch::test_time_precision_pair_reports_changed_when_rounded_values_still_differ PASSED [ 29%]
tests/integration/test_m1_fixtures.py::TestDecimalFixtures::test_pair_compares_at_min_scale_of_the_two_sides PASSED [ 30%]
tests/integration/test_m1_fixtures.py::TestDecimalFixtures::test_negative_zero_renders_as_zero PASSED [ 30%]
...
tests/integration/test_m1_fixtures.py::TestFloatFixtures::test_default_15_significant_figures_scientific_notation PASSED [ 31%]
...
tests/integration/test_m1_fixtures.py::TestFloatFixtures::test_nan_both_sides_nan_is_equal PASSED [ 32%]
tests/integration/test_m1_fixtures.py::TestFloatFixtures::test_infinity_renders_literally PASSED [ 33%]
tests/integration/test_m1_fixtures.py::TestFloatFixtures::test_float_precision_override_changes_significant_digit_count PASSED [ 33%]
tests/integration/test_m1_fixtures.py::TestStringFixtures::test_str1_no_trim_no_case_fold_by_default PASSED [ 33%]
tests/integration/test_m1_fixtures.py::TestStringFixtures::test_str2_trim_makes_trailing_whitespace_variant_match PASSED [ 34%]
tests/integration/test_m1_fixtures.py::TestStringFixtures::test_strasse_vs_strasse_differ_even_case_insensitive PASSED [ 34%]
tests/integration/test_m1_fixtures.py::TestStringFixtures::test_emoji_rtl_and_10000_char_string_pass_through_unchanged PASSED [ 35%]
tests/integration/test_m1_fixtures.py::TestStringFixtures::test_nul_byte_cannot_be_stored_in_postgres_text PASSED [ 35%]
...
tests/integration/test_m1_fixtures.py::TestNullFixtures::test_null_vs_zero_int PASSED [ 36%]
tests/integration/test_m1_fixtures.py::TestBooleanFixtures::test_true_false_render_as_literal_words PASSED [ 37%]
tests/integration/test_m1_fixtures.py::TestBooleanFixtures::test_boolean_vs_integer_0_1_is_excluded_as_incompatible_not_silently_mapped PASSED [ 37%]
...
tests/integration/test_m1_fixtures.py::TestUuidFixtures::test_uuid_without_hyphens_input_still_renders_hyphenated PASSED [ 38%]
tests/integration/test_m1_fixtures.py::TestArrayFixtures::test_int_array_renders_bracket_format_order_sensitive PASSED [ 39%]
tests/integration/test_m1_fixtures.py::TestArrayFixtures::test_empty_array_vs_null_stay_distinct PASSED [ 39%]
tests/integration/test_m1_fixtures.py::TestArrayFixtures::test_text_array_with_null_element PASSED [ 40%]
tests/integration/test_m1_fixtures.py::TestJsonFixtures::test_jsonb_key_order_is_engine_side_canonicalised PASSED [ 40%]
tests/integration/test_m1_fixtures.py::TestJsonFixtures::test_plain_json_also_canonicalised_via_jsonb_cast PASSED [ 41%]
tests/integration/test_m1_fixtures.py::TestEnumFixtures::test_enum_renders_as_label_text PASSED [ 41%]
...
tests/integration/test_m1_fixtures.py::TestDateTimeFixtures::test_date_renders_iso PASSED [ 42%]
tests/integration/test_m1_fixtures.py::TestDateTimeFixtures::test_time_renders_with_six_fractional_digits PASSED [ 43%]
tests/integration/test_m1_fixtures.py::TestUnknownTypeNeverFailsARun::test_unknown_type_falls_back_to_text_cast_and_warns_once PASSED [ 43%]
tests/integration/test_run_and_connections.py::TestRunCommand::test_run_reports_match_for_every_table_pair PASSED [ 44%]
tests/integration/test_run_and_connections.py::TestRunCommand::test_run_exit_code_is_worst_across_all_table_pairs PASSED [ 44%]
tests/integration/test_run_and_connections.py::TestRunCommand::test_run_with_env_var_secret_in_dsn PASSED [ 44%]
...
tests/integration/test_run_and_connections.py::TestConnectionsTestCommand::test_connections_test_fails_clearly_for_a_bad_connection PASSED [ 45%]
...
tests/unit/test_cli_spec.py::test_parses_schema_and_table PASSED         [ 46%]
tests/unit/test_cli_spec.py::test_table_without_explicit_schema_defaults_to_none PASSED [ 47%]
tests/unit/test_cli_spec.py::test_missing_table_raises_clear_error PASSED [ 47%]
tests/unit/test_clickhouse_connector.py::TestUnwrap::test_bare_type_is_not_nullable PASSED [ 48%]
tests/unit/test_clickhouse_connector.py::TestUnwrap::test_nullable_wrapper_strips_and_flags_nullable PASSED [ 48%]
...
tests/unit/test_clickhouse_connector.py::TestUnwrap::test_low_cardinality_of_nullable_strips_both_and_flags_nullable PASSED [ 49%]
tests/unit/test_clickhouse_connector.py::TestUnwrap::test_wrapper_stripping_does_not_touch_unrelated_parens PASSED [ 50%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_every_int_width_and_signedness_maps_to_int_1 PASSED [ 50%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_float32_and_float64_map_to_flt_1 PASSED [ 51%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_decimal_reports_scale_and_maps_to_dec_1 PASSED [ 51%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_decimal_with_no_explicit_scale_defaults_to_zero PASSED [ 52%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_fixed_width_decimal_variants_report_their_scale PASSED [ 52%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_datetime_maps_to_ts_1_family_with_precision_zero PASSED [ 53%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_datetime64_reports_its_precision_and_maps_to_ts_1_family PASSED [ 53%]
...
tests/unit/test_clickhouse_connector.py::TestResolve::test_bool_maps_to_bool_1 PASSED [ 55%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_enum8_and_enum16_map_to_enum_1 PASSED [ 56%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_array_maps_to_arr_1 PASSED [ 56%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_map_falls_back_to_unk_1_per_spec PASSED [ 57%]
tests/unit/test_clickhouse_connector.py::TestResolve::test_tuple_falls_back_to_unk_1 PASSED [ 57%]
...
tests/unit/test_clickhouse_connector.py::TestGetSchemaAndPrimaryKey::test_get_primary_key_returns_none_when_no_rows PASSED [ 58%]
tests/unit/test_clickhouse_connector.py::TestGetSchemaAndPrimaryKey::test_get_primary_key_returns_names_in_order PASSED [ 59%]
tests/unit/test_clickhouse_connector.py::TestNormaliseExprShape::test_int_1_wraps_null_check_when_nullable PASSED [ 59%]
...
tests/unit/test_clickhouse_connector.py::TestNormaliseExprShape::test_row_hash_expr_multi_column_joins_with_unit_separator PASSED [ 60%]
tests/unit/test_clickhouse_connector.py::TestNormaliseExprShape::test_quote_identifier_escapes_backtick PASSED [ 61%]
tests/unit/test_clickhouse_connector.py::TestNormaliseExprShape::test_quote_literal_escapes_quotes_and_backslashes PASSED [ 61%]
...
tests/unit/test_clickhouse_hash_reference.py::TestCrossEngineHashReference::test_postgres_and_simulated_clickhouse_agree[] PASSED [ 62%]
...
tests/unit/test_column_matching.py::test_matched_columns_present_on_both_sides PASSED [ 66%]
tests/unit/test_column_matching.py::test_case_insensitive_name_matching PASSED [ 67%]
tests/unit/test_column_matching.py::test_column_map_override PASSED      [ 67%]
tests/unit/test_column_matching.py::test_source_only_column_excluded_as_schema_difference PASSED [ 68%]
tests/unit/test_column_matching.py::test_incompatible_type_families_excluded_and_reported_loudly PASSED [ 68%]
tests/unit/test_column_matching.py::test_compatible_text_type_families_are_fine PASSED [ 69%]
tests/unit/test_column_matching.py::test_unk_1_never_excludes_a_column PASSED [ 69%]
tests/unit/test_column_matching.py::test_dec_1_uses_min_scale_of_the_pair_and_warns PASSED [ 70%]
tests/unit/test_column_matching.py::test_dec_1_same_scale_no_warning PASSED [ 70%]
tests/unit/test_column_matching.py::test_ts_2_upgrade_when_precision_differs PASSED [ 71%]
tests/unit/test_column_matching.py::test_no_ts_2_upgrade_when_precision_matches PASSED [ 71%]
...
tests/unit/test_hashdiff_core.py::TestCompositeKey::test_composite_key_tenant_and_order_id PASSED [ 77%]
tests/unit/test_hashdiff_core.py::TestUuidKey::test_uuid_key_table_diffs_correctly PASSED [ 78%]
tests/unit/test_hashdiff_core.py::TestNoPrimaryKey::test_no_pk_and_no_explicit_key_raises PASSED [ 78%]
tests/unit/test_hashdiff_core.py::TestNonUniqueKey::test_non_unique_explicit_key_raises_with_example PASSED [ 79%]
tests/unit/test_hashdiff_core.py::TestMaxDiffRowsCap::test_diff_row_collection_is_capped_and_marked_truncated PASSED [ 79%]
...
tests/unit/test_hashdiff_core.py::TestNonNumericKeySegmentationCoverage::test_target_only_row_below_source_min_with_text_key PASSED [ 80%]
...
tests/unit/test_normalisation.py::test_date_picks_date_1 PASSED          [ 88%]
tests/unit/test_normalisation.py::test_time_types_pick_time_1 PASSED     [ 89%]
tests/unit/test_normalisation.py::test_timestamp_with_time_zone_picks_ts_1 PASSED [ 89%]
